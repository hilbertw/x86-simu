...
/// used internally
__declspec(noreturn) void throwLogicError(String const& msg);
...
public:
  ...
  __declspec(deprecated("Use setComment(String const&) instead."))
...
public:
  ...
  /// embedded nulls.
  __declspec(deprecated("Use `key = name();` instead."))
