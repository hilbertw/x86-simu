...
int CExcelUtil::OpenEx (LPWSTR lpszFileName)
{
  ...
  // 创建进行存取的字符串
  sSql.Format(L"DRIVER={%s};DSN='';FIRSTROWHASNAMES=1;READONLY=FALSE;DBQ=%s;CREATE_DB=\"%s\";Extended Properties=\"Excel 8.0;HDR=no;IMEX=0\";",sDriver, sExcelFile, sExcelFile);
